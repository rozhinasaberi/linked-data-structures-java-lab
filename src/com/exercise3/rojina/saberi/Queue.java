/*
 * lab 4 ex 3
 * this interface lists the queue operations
 * it is here to show the queue rules before the linked implementation details
 * enqueue dequeue first size and isempty all belong to the queue adt
 */
/*
