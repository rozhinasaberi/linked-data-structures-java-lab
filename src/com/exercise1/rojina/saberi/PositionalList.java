/*
 * lab 4 ex 1
 * this interface is specifically for positional lists
 * here is where methods like before after addbefore addafter are declared
 * it is separated from the class so the structure and the actual code are not mixed up
 */
/*
