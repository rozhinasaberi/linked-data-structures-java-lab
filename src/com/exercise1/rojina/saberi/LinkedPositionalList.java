/*
 * lab 4 ex 1
 * this file is the real positional list implementation
 * the interfaces are separate files but this one has the nodes and all add remove logic
 * doubly linked nodes are used so moving before and after a position is easier
 * i also added my search idea here because this class already knows how to walk the list
 */
/*
