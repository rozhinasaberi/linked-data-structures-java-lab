/*
 * lab 4 ex 1
 * this file is just the basic list interface
 * it tells what operations a list should have
 * interface is used so the design is cleaner before the implementation class
 */
/*
